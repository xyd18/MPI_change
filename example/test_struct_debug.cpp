...
#include <stdlib.h>
#include "config.h"
#include "../my_send/my_send.h"
#include "../my_send/mem_manager.h"
...
int main(int argc, char **argv)
{
	...
	{
		double sum = 0.;
		struct Data *datas = (struct Data*)(my_malloc(TEST_TIME * sizeof(struct Data)));
		...
		for (int i = 0; i < TEST_TIME; i++)
		{
			...
			struct timeval tv;
			my_recv(1, 1, data, sizeof(struct Data));
		...
		for (int i = 0; i < TEST_TIME; i++)
		{
			struct Data *data =  (struct Data*)(my_malloc(sizeof(struct Data)));
	...
	else if (my_rank == 1)
	{
		...
		for (int i = 0; i < TEST_TIME; i++)
		{
			...
			my_send(0, 1, data, sizeof(struct Data));
		}
		my_free(datas);
